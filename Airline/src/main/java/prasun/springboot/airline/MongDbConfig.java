...
@EnableJpaRepositories(basePackages = {
		"prasun.springboot.airline" }, entityManagerFactoryRef = "mongoEntityManager", transactionManagerRef = "mongoTransactionManager")
...
public class MongDbConfig extends AbstractMongoClientConfiguration{
	...
	public LocalContainerEntityManagerFactoryBean mongoEntityManager() throws Throwable {
		...
		entityManager.setPackagesToScan("prasun.springboot.airline.entity");// This is required so that the hibernate
